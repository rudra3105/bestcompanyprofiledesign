    ...
    var t = function() {
            ...
            return function() {
                if (!t || !t.requirejs) {
                    ...
                    ! function(t) {
                        ...
                        function s(e, t) {
                            ...
                            if (e && "." === e.charAt(0))
                                if (t) {
                                    for (o = (e = e.split("/")).length - 1, y.nodeIdCompat && b.test(e[o]) && (e[o] = e[o].replace(b, "")), e = h.slice(0, h.length - 1).concat(e), u = 0; u < e.length; u += 1)
                        ...
                        f = function(e, t) {
                            var n, i = u(e),
                                r = i[0];
                            return e = i[1], r && (n = c(r = s(r, t))), r ? e = n && n.normalize ? n.normalize(e, a(t)) : s(e, t) : (r = (i = u(e = s(e, t)))[0], e = i[1], r && (n = c(r))), {
                                f: r ? r + "!" + e : e,
                                n: e,
                                pr: r,
                                p: n
                            ...
                            if (s = s || e, "undefined" === w || "function" === w) {
                                for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)
                                    if (p = f(n[h], s), "require" === (u = p.f)) $[h] = g.require(e);
                                ...
                                d = i ? i.apply(m[e], $) : undefined, e && (a && a.exports !== t && a.exports !== m[e] ? m[e] = a.exports : d === t && y || (m[e] = d))
                            } else e && (m[e] = i)
                        }, e = n = h = function(e, n, i, r, s) {
                            if ("string" == typeof e) return g[e] ? g[e](n) : c(f(e, n).f);
                            if (!e.splice) {
                                if ((y = e).deps && h(y.deps, y.callback), !n) return;
                                n.splice ? (e = n, n = i, i = null) : e = t
                            }
                            return n = n || function() {}, "function" == typeof i && (i = r, r = s), r ? p(t, e, n, i) : setTimeout(function() {
                                p(t, e, n, i)
                            }, 4), h
                        }, h.config = function(e) {
                            return h(e)
                ...
                return t.Extend(i, e), i.prototype.current = function(e) {
                    ...
                    if (this.$element.prop("multiple")) this.current(function(i) {
                        ...
                        for (var s = 0; s < e.length; s++) {
                            var o = e[s].id; - 1 === n.inArray(o, r) && r.push(o)
                        }
                ...
                function t(t, n, i) {
                    ...
                    if (o !== undefined && (this.insertTag = o), t.call(this, n, i), e.isArray(r))
                ...
                return t.prototype.query = function(e, t, n) {
                    function i(e, s) {
                        for (var o = e.results, a = 0; a < o.length; a++) {
                            ...
                            if (l.text === t.term || c) return !s && (e.data = o, void n(e))
                        }
                        if (s) return !0;
                        var u = r.createTag(t);
                        if (null != u) {
            ...
            }), t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function(e, t, n, i, r, s, o, a, l, c, u, d, p, h, f, g, m, v, y, _, $, w, b, A, x, E, C, O, S) {
                function T() {
                    this.reset()
                }
