        ...
        f = {
            init: function(e) {
                var o, a, t, _ = e,
                    ...
                    r = [],
                    d = {};
                n && void 0 !== e ? (t = window.elementor.elements, o = _.data("id"), a = _.hasClass("elementor-inner-section"), i.each(t.models, function(e, t) {
                    ...
                    e.forEach(function(e) {
                        void 0 !== e.parallax_type && "parallax" === e.parallax_type && (_ = i('[data-id="' + t + '"]'), r.parallax_type = e.parallax_type, r.parallax_image_url = e.parallax_image.url, void 0 !== r.parallax_image_url && (r.enable_parallax = "parallax")), void 0 !== e.offset_type && "offset" === e.offset_type && (_ = i('[data-id="' + t + '"]'), r.offset_type = e.offset_type, r.offset_image_url = e.offset_image.url, r.offset_parallax = e.offset_parallax, r.offset_vertical_anchor = e.offset_vertical_anchor, r.offset_vertical_position = e.offset_vertical_position, r.offset_horizontal_anchor = e.offset_horizontal_anchor, r.offset_horizontal_position = e.offset_horizontal_position, void 0 !== r.offset_image_url && (r.enable_offset = "offset")), void 0 !== _ && (f.generateOutput(_, r), r = [])
                    })
                }))
            },
            generateOutput: function(e, t) {
                var o;
                void 0 !== t.enable_parallax && "parallax" === t.enable_parallax && void 0 !== t.parallax_image_url && (i(".qodef-parallax-row-holder", e).remove(), e.removeClass("qodef-parallax qodef--parallax-row"), e.addClass("qodef-parallax qodef--parallax-row"), i('<div class="qodef-parallax-row-holder"><div class="qodef-parallax-img-holder"><div class="qodef-parallax-img-wrapper"><img class="qodef-parallax-img" src="' + t.parallax_image_url + '" alt="Parallax Image"></div></div></div>').prependTo(e), (o = new Image).onload = function() {
        ...
        d = {
            init: function(e) {
                ...
                if (t && void 0 !== e) {
                    ...
                    i.each(n.models, function(e, t) {
                        i.each(t.attributes.elements.models, function(e, t) {
                            r == t.id && (_ = t.attributes.settings.attributes)
                        })
